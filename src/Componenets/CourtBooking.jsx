...
const handleCourtDataChg =(e)=>{
  ...
  const upadteEditedCD=()=>{
    AxiosInstance.post('/admin/upadteEditedCD',editCourtData).then((res)=>{
setCourtEditModal(false)
// setSingleCourtData(editCourtData)  // if there is no image
getSinglecourtData()
    })
    .catch((err)=>{
...
<input type="text" onChange={handleCourtDataChg}  value={editCourtData.type}/>
<button onClick={upadteEditedCD}>Save</button>
